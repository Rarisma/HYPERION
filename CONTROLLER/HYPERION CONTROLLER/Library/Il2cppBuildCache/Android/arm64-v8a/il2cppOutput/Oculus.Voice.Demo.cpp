...
IL_000b:
	...
	}
	{
		...
		bool L_5;
		L_5 = String_op_Equality_m2B91EE68355F142F67095973D32EB5828B7B73CB(L_4, _stringLiteralDD0F04E0A3F0BA1F904E0E27720F367F4228C69D, /*hidden argument*/NULL);
		if (!L_5)
		{
			goto IL_004a;
		}
...
IL_0024:
	{
		...
		ColorChanger_SetColor_m8D12B2E15896D811B757756E77C3A0B2864D9E2E(__this, L_8, L_9, /*hidden argument*/NULL);
		// for (int i = 0; i < transform.childCount; i++)
		int32_t L_10 = V_1;
...
IL_004e:
	{
		...
		bool L_20;
		L_20 = String_Equals_mD65682B0BB7933CC7A8561AE34DED02E4F3BBBE5(L_17, L_19, 1, /*hidden argument*/NULL);
		if (!L_20)
		{
			goto IL_0073;
		}
	}
	{
		...
		Color_tF40DAF76C04FFECF3FE6024F85A294741C9CC659  L_22 = V_0;
		ColorChanger_SetColor_m8D12B2E15896D811B757756E77C3A0B2864D9E2E(__this, L_21, L_22, /*hidden argument*/NULL);
		// break;
		return;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void InteractionHandler_OnEnable_m5288C2230CB27FC490E3681F13C344A83410EBA8 (InteractionHandler_t4FFA3451A92898C717FC21AF73FEF0CAFB30CF03 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		NullCheck(L_5);
		WitTranscriptionEvent_t173FC642ECF9BBC8DC629B2978E5EE883F2BFC3E * L_6 = L_5->get_OnPartialTranscription_14();
		...
		NullCheck(L_9);
		WitTranscriptionEvent_t173FC642ECF9BBC8DC629B2978E5EE883F2BFC3E * L_10 = L_9->get_OnFullTranscription_15();
...
IL_0024:
	{
		...
		NullCheck(L_5);
		VirtActionInvoker0::Invoke(29 /* System.Void Facebook.WitAi.VoiceService::Deactivate() */, L_5);
	}
